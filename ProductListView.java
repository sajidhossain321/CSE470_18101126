...
public class ProductListView extends JFrame {
    ...
    public void initialize(ProductListModel plm, Connection connection){
        ...
        desktopPane.setBorder(new TitledBorder(new BevelBorder(BevelBorder.LOWERED, null, null, null, null), "Product Data", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
        desktopPane.setBackground(new Color(255, 233, 0, 255));
        ...
        lblProductName.setBounds(10, 52, 42, 30); //comment
